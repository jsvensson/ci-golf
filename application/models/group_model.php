...
class Group_model extends CI_Model
{
  ...
  public function add_player_to_group($user_id, $group_id)
  {
    $data = array($user_id, $group_id);
    return $this->db->insert('UserGroups', $data);
  }

  public function add_players_to_group($user_id_array, $group_id)
  {
    foreach ($user_id_array as $user_id) {
      add_player_to_group($user_id, $group_id);
    }
  }

  public function remove_player_from_group($user_id, $group_id)
  {
    $this->db
